...
const usersApi = {
  ...
  update: async (id: string, data: Partial<{ name: string; email: string; role: string; cell_id: string | null; cell_ids: string[]; funcao_na_celula: string | null; leader_cell_id: string | null }>) => {
